...
def instagram(phone):
    ...
    if d["status"] == "ok":
        print("[*] FB:NAT NAT YT:Phto X tuu✅")
    else:
        print("[*] FB:NAT NAT YT:Phto X tuu✅")
...
def homepro(phone):
    ...
    if d["msgtype"] == "success":
        print("[*] เฟสบุ๊ค:NAT NAT YT:Phto X tuu✅")
    else:
        print("[*] เฟสบุ๊ค:NAT NAT YT:Phto X tuu✅")
